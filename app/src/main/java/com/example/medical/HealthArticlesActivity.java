...
public class HealthArticlesActivity extends AppCompatActivity {
    private String[][] health_details =
            {
                    {"Celebral Health", "", "", "", "Click More Details"},
                    {"Behavioural Health", "", "", "", "Click More Details"},
                    {"Future of Healthcare", "", "", "", "Click More Details"},
                    {"Heart Disease for Women", "", "", "", "Click More Details"},
                    {"Healthcare Technology", "", "", "", "Click More Details"}
            };
    private int[] images = {
            R.drawable.health1,
            R.drawable.health2,
